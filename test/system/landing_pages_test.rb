...
class LandingPagesTest < ApplicationSystemTestCase
  ...
  test "should create landing page" do
    ...
    fill_in "Copywriting", with: @landing_page.copywriting
    fill_in "Services", with: @landing_page.services_id
    fill_in "Styles", with: @landing_page.styles
  ...
  test "should destroy Landing page" do
    visit landing_page_url(@landing_page)
    accept_confirm { click_on "Destroy this landing page", match: :first }
